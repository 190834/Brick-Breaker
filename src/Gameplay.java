...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
	private boolean play = false; // Makes sure that the game doesn't start by itself
	private int score = 0;
	...
	public void actionPerformed(ActionEvent e) {
		...
		repaint(); // draws everything again
	}
	...
	public void keyPressed(KeyEvent e) {
		if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
			if (playerX >= 600) {
				playerX = 600;// Make sure it doesn't go out of panel
			} else {
				moveRight();
			}
